  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="d-md-flex">
      <div class="one-half align-self-center">
        &nbsp &nbsp &nbsp &nbsp &nbsp <img src="img/logo.jpg" width="700" height="700">
      </div>
      <div class="one-forth ml-md-5 align-self-center">
        ...
        <div class="text mt-5">
          ...
          <form action="php/book.php" name="form2" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <input id="savebtn" type="submit" name="setapp" value="Set An Appointment" class="btn btn-secondary py-3 px-5">
            </div>
          </form>
        </div><br><br>
      </div>
