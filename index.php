                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome to Thirty-two Dental Care Center</h5>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 text-center heading-section ftco-animate">
          <img src="img/why.jpg" width="450px" height="400px" alt=""><br>
      ...
      <div class="row">
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            ...
            <img src="img/incisor.png"width="50px" height="50px" alt="">
            </div>
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            ...
            <img src="img/clean.png"width="50px" height="50px" alt="">
            </div>
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            <div class="icon d-flex align-items-center justify-content-center">
            <img src="img/teeth.png"width="50px" height="50px" alt="">
            </div>
            <div class="media-body pl-4">
              <a href="service4.php">
              ...
              <p class="mb-0"><i>Additional reinforcement for denture will charge and discuss on chairside</i></p>
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            <div class="icon d-flex align-items-center justify-content-center order-md-last">
            <img src="img/enamel.png"width="50px" height="50px" alt="">
            </div>
            <div class="media-body pl-4 pl-md-0 pr-md-4 text-md-right">
              <a href="service5.php">
        ...
        <div class="col-md-6 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-flex align-items-center">
            <div class="icon d-flex align-items-center justify-content-center">
            <img src="img/tooth-whitening.png"width="50px" height="50px" alt="">
            </div>
            <div class="media-body pl-4">
              <a href="service6.php">
              ...
              <p class="mb-0"><i>Pure porcelain starts ₱ 9,000 depend on class of porcelain used Per Month</i></p>
              <p class="mb-0"><i>**additional charges for infection control and check up**</i></p>
          ...
          <div class="carousel-testimony owl-carousel ftco-owl">
            <div class="item">
              <div class="testimony-wrap p-4 text-center">
                <div class="user-img mb-4" style="background-image: url(img/doc.png)">
    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-3 ftco-animate">
        <div class="col-md-12 text-center heading-section ftco-animate">
          ...
          kamuning That specialize oral care. The main dental doctor in the clinic is Dr. Mark Tee Jay Aguila. 
          The opening and closing time of Thirty Two Dental Clinic Center are: Mon to Sat: 9:00 AM-7:00 PM. 
          Some of the services provided by the clinic are: ORAL PROPHYLAXYS or CLEANING, RESTORATION OR PASTA, TOOTH EXTRACTION, DENTURES and Jacket Crown or Fixed Bridge
