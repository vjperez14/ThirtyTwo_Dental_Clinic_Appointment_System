        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
              ...
              switch ($isActive) {
                  case 'value':{
                      ?>
                    <li class='nav-item cta active'><a href='myaccount' class='nav-link'><span>My Account</span></a>
                    </li>
          ...
          ?>
            ...
            <div class="row">
                <div class="col-md-12 nav-link-wrap mb-5 pb-md-5 pb-sm-1 ftco-animate">
                    <div class="nav ftco-animate nav-pills justify-content-left text-center" id="v-pills-tab"
                        role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-nextgen-tab" data-toggle="pill" href="#v-pills-nextgen"
                            role="tab" aria-controls="v-pills-nextgen" aria-selected="true"
                            style="color: black">Dashboard <img src="assets/images/dashboard.png"
                        ...
                        <a class="nav-link" id="v-pills-performance-tab" data-toggle="pill" href="#v-pills-performance"
                            ...
                            style="color: black">Edit Profile <img src="assets/images/user1.png"
                                style="width:30px;height:30px;"></a>

                        <a class="nav-link" id="v-pills-effect-tab" data-toggle="pill" href="#v-pills-effect" role="tab"
                            aria-controls="v-pills-effect" aria-selected="false" style="color:black">Cancellation
                            Policies <img src="assets/images/login.png" style="width:30px;height:30px;"></a>
                    </div>
                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-effect" role="tabpanel"
                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="order-first align-self-center" style="margin-left: -20%;">
                                    <h3 class="heading"> Please kindly note we operate a 24 hours cancellation policy
                                    </h3>
                                    <p> * If you do not give us 24 hours notice to cancel your appoinment we will charge
                                        you</p>
                                    <p> * For an hour appointment it is ₱500</p>
                                    <p> * Please give us as much notice to cancel your appointment. this gives me plenty
                                        of time to fill your appointment space</p>
