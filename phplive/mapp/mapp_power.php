...
<div id="canned_container" style="padding: 15px; padding-top: 25px; height: 200px; overflow: auto;">
	...
	<div id="div_settings_profile" style="margin-top: 25px; padding-bottom: 50px;">
		<div class="info_content">
			...
			<tr>
				<td><img src="<?php echo $profile_pic_url ?>" width="55" height="55" border=0 class="profile_pic_img" style="border-radius: 50%;"></td>
		...
		<div style="margin-top: 15px; padding-bottom: 100px;">
			<div id="chat_info_wrapper_network_info">
				...
				<tr><td colspan=3 class="chat_info_td"><div class="info_box">
					<table cellspacing=0 cellpadding=0 border=0 width="100%"><tr><td width="60%">Network Status &nbsp; <img src="../themes/<?php echo $theme ?>/view.png" width="16" height="16" border="0" alt="detailed log" title="detailed log" style="cursor: pointer;" onClick="parent.toggle_debug()"></td></tr></table>
				</div></td></tr>
				<tr>
