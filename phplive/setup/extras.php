...
<!--
	...
	function do_submit()
	{
		...
		if ( name == "" )
			...
			do_alert( 0, "URL must begin with HTTPS or HTTP." )
		else if ( !flag )
		{
			// let it pass for now to reset if only 1 operator assigned previously
			//do_alert( 0, "At least one operator must be checked." ) ;
			$('#theform').submit() ;
		}
		else
			$('#theform').submit() ;
...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="display: none; margin-top: 25px;" id="extras_external">
			...
			<?php if ( count( $operators ) ): ?>
				...
				<div style="padding: 5px; margin-top: 55px;">
					...
					<div style="margin-top: 10px;">
						...
						<tr>
							<td>Name<br><input type="text" class="input" name="name" id="name" size="50" maxlength="15" value="" autocomplete="off"></td>
						</tr>
						<tr>
							<td>Target URL<br><input type="text" class="input" name="url" id="url" size="120" maxlength="255" value="" autocomplete="off"></td>
						</tr>
						<tr>
							<td style="padding-top: 15px;">
								<div><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""> It is recommended that each operator has max 3 external URLs to maintain proper operator console formatting.</div>
								<div style="margin-top: 15px;">Operator(s) who can access this external URL:</div>
								<div id="li_ops" style="margin-top: 5px;" class="info_white">
									<div class="li_op_focus round" style="border: 1px solid #FFFFFF;"><input type="checkbox" id="ck_op_all" name="opids[]" value="all" onClick="check_all(this)"> <label for="ck_op_all" style="cursor: pointer;">Check All</label></div>
									<?php
						...
						<tr>
							<td style="padding-top: 15px;">
								...
								<div style="padding-top: 15px;"><input type="button" value="Submit" onClick="do_submit()" class="btn"> &nbsp; &nbsp; <input type="reset" value="Reset" onClick="$( 'input#extid' ).val(0)" class="btn"></div>
							</td>
						</tr>
						</table>
						</form>
			...
			<?php else: ?>
			<div style="margin-top: 15px;"><span class="info_error"><img src="../pics/icons/warning.png" width="12" height="12" border="0" alt=""> Add an <a href="ops.php" style="color: #FFFFFF;">Operator</a> to view this area.</span></div>
			<?php endif ;?>
		</div>
