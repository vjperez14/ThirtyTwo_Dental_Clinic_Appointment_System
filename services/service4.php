...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/service4.css">
</head>
              ...
              switch ($isActive) {
                  case 'value':{
                      ?>
                        ...
                        <li class='nav-item'><a style="color:black" href='../assets/php/logout.php' class='nav-link'><span>Logout</span></a></li>
                      <?php
                  break;
                  }
                  default:{
      ...
      <div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-end">
        ...
        <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
          <div class="text mt-5">
            ...
            <h1 class="mb-3"><span>DENTURES</span></h1>
            <p class="mb-0">1-8 teeth per Arch ₱800</p>
            <p class="mb-0">Complet Denture/ almost complete ₱2,000</p>
