  ...
  <div class="hero-wrap js-fullheight">
    ...
    <div class="container-fluid px-0">
      <div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-end">
        <img class="one-third js-fullheight align-self-end order-md-last img-fluid" src="../assets/img/teeth.png"
          alt="">
        <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
          <div class="text mt-5">
            ...
            <p class="mb-0"><?php echo '<a href="../appointment.php?service=5" class="btn btn-secondary py-3 px-4">Set An Appointment</a>' ?></p>
          </div>
        </div>
      </div>
    </div>
